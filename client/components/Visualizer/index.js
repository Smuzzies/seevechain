...
export default function Visualizer() {
  ...
  const handleSwitchToMainnet = () => {
    window.location.href = 'https://myvechain.com';
  };
  ...
  return <div className="Visualizer">
    ...
    />
    <div className="floating-button" onClick={handleSwitchToMainnet}>Switch to MAINNET</div>
  </div>
}
...
function BlockNumber() {
  ...
  return <a
    href={`https://explore-testnet.vechain.org/accounts/${currentBlock.block.number}/`}
    target="_blank"
